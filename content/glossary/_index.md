...
| 👷 | Bitcoin dominance | The term used to illustrate how much importance Bitcoin currency to scale in the overall crypto economy. It's the ratio between the market cap of Bitcoin to the rest of the cryptocurrency markets. It provides traders valuable information useful in gaining insight into markets, more specifically sentiment of traders. The price of an asset is a function of supply and demand, so the index effectively measures demand for Bitcoin relative to the demand for altcoins. |
